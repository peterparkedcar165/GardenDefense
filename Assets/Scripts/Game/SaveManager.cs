...
public class SaveManager : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            string[] all = { "AcornSprout", "Sunflower", "Waterlily", "LeafRanger", "Dandelion", "Snowdrop", "PoisonShroom", "Calendula", "BogIris", "Begonia", "Holly", "AloeVera", "Cactus", "Aeonium", "NeriumOleander", "GlowingMushroom" };
    ...
    private string GetPlantUnlockedByLevel(int level)
    {
        switch (level)
        {
            ...
            case 15: return "GlowingMushroom";
            default: return null;
        }
    }
}