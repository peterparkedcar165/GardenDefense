...
public class DaytimeGridManager : MonoBehaviour
{
    ...
    void GenerateGrid()
    {
        ...
        for (int x = 0; x < columns; x++)
        {
            for (int y = 0; y < rows; y++)
            {
                ...
                GameObject tileGO = Instantiate(grassTilePrefab, worldPos, Quaternion.identity, transform);
                ...
                // priority: collider > path > water > dirt > highground > lowground > ground (default grass)
