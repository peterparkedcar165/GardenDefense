...
public class Level13 : SpawnManager
{
    ...
    IEnumerator Wave(int wave)
    {
        if (wave == 1)
        {
            ...
            InvokeRepeating(nameof(SpawnMoth),           wd1 / 2f,   18f);
            InvokeRepeating(nameof(SpawnFirefly),        wd1 / 2f,   20f);
        ...
        } else if (wave == 2)
        {
            ...
            InvokeRepeating(nameof(SpawnMoth),           wd2 / 2f,   16f);
            InvokeRepeating(nameof(SpawnFirefly),        wd2 / 2f,   18f);
        ...
        } else if (wave == 3)
        {
            ...
            InvokeRepeating(nameof(SpawnScorpion),       waitTime,    wd3 / 2.2f); // start/mid/end
            InvokeRepeating(nameof(SpawnMoth),           wd3 / 2f,   14f);
            InvokeRepeating(nameof(SpawnFirefly),        wd3 / 2f,   16f);
        ...
        } else if (wave == 4)
        {
            ...
            InvokeRepeating(nameof(SpawnScorpion),       waitTime,    15f);
            InvokeRepeating(nameof(SpawnMoth),           wd4 / 2f,   12f);
            InvokeRepeating(nameof(SpawnFirefly),        wd4 / 2f,   14f);
        ...
        } else if (wave == 5)
        {
            ...
            InvokeRepeating(nameof(SpawnScorpion),       waitTime,    12f);
            InvokeRepeating(nameof(SpawnMoth),           wd5 / 2f,   10.5f);
            InvokeRepeating(nameof(SpawnFirefly),        wd5 / 2f,   12f);
        ...
        } else if (wave == 6)
        {
            ...
            InvokeRepeating(nameof(SpawnScorpion),       waitTime,    10.5f);
            InvokeRepeating(nameof(SpawnMoth),           wd6 / 2f,   9f);
            InvokeRepeating(nameof(SpawnFirefly),        wd6 / 2f,   10.5f);
        ...
        } else if (wave == 7)
        {
            ...
            InvokeRepeating(nameof(SpawnScorpion),       wd7 / 3f,     9.0f);
            InvokeRepeating(nameof(SpawnFireAnt),        waitTime,      2.65f);
            InvokeRepeating(nameof(SpawnTermiteCluster), wd7 / 4f,     6.5f);
            InvokeRepeating(nameof(SpawnMoth),           wd7 / 3f,     8f);
            InvokeRepeating(nameof(SpawnFirefly),        wd7 / 3f,     9f);
        ...
        } else if (wave == 8)
        {
            ...
            InvokeRepeating(nameof(SpawnScorpion),       wd8 / 3f,     8.0f);
            InvokeRepeating(nameof(SpawnFireAnt),        waitTime,      2.4f);
            InvokeRepeating(nameof(SpawnTermiteCluster), wd8 / 4f,     6.0f);
            InvokeRepeating(nameof(SpawnMoth),           wd8 / 3f,     7f);
            InvokeRepeating(nameof(SpawnFirefly),        wd8 / 3f,     8f);
        ...
        } else if (wave == 9)
        {
            ...
            InvokeRepeating(nameof(SpawnScorpion),       wd9 / 3f,     7.0f);
            InvokeRepeating(nameof(SpawnFireAnt),        waitTime,      2.15f);
            InvokeRepeating(nameof(SpawnTermiteCluster), wd9 / 4f,     5.5f);
            InvokeRepeating(nameof(SpawnMoth),           wd9 / 3f,     6.5f);
            InvokeRepeating(nameof(SpawnFirefly),        wd9 / 3f,     7f);
        ...
        } else if (wave == 10)
        {
            ...
            InvokeRepeating(nameof(SpawnScorpion),        wd10 / 3f,     6.5f);
            InvokeRepeating(nameof(SpawnFireAnt),         waitTime,       2.15f);
            InvokeRepeating(nameof(SpawnTermiteCluster),  wd10 / 4f,     5.0f);
            InvokeRepeating(nameof(SpawnMoth),            wd10 / 3f,     6f);
            InvokeRepeating(nameof(SpawnFirefly),         wd10 / 3f,     6.5f);
        ...
        } else if (wave == 11)
        {
            ...
            InvokeRepeating(nameof(SpawnScorpion),        wd11 / 3f,     6.0f);
            InvokeRepeating(nameof(SpawnFireAnt),         waitTime,       1.9f);
            InvokeRepeating(nameof(SpawnTermiteCluster),  wd11 / 4f,     4.5f);
            InvokeRepeating(nameof(SpawnMoth),            wd11 / 3f,     5.5f);
            InvokeRepeating(nameof(SpawnFirefly),         wd11 / 3f,     6f);
        ...
        } else if (wave == 12)
        {
            ...
            InvokeRepeating(nameof(SpawnScorpion),        wd12 / 3f,     5.5f);
            InvokeRepeating(nameof(SpawnFireAnt),         waitTime,       1.9f);
            InvokeRepeating(nameof(SpawnTermiteCluster),  wd12 / 4f,     4.25f);
            InvokeRepeating(nameof(SpawnMoth),            wd12 / 3f,     5f);
            InvokeRepeating(nameof(SpawnFirefly),         wd12 / 3f,     5.5f);
        ...
        } else if (wave == 13)
        {
            ...
            InvokeRepeating(nameof(SpawnScorpion),        wd13 / 3f,     5.0f);
            InvokeRepeating(nameof(SpawnFireAnt),         waitTime,       1.65f);
            InvokeRepeating(nameof(SpawnTermiteCluster),  wd13 / 4f,     4.0f);
            InvokeRepeating(nameof(SpawnMoth),            wd13 / 3f,     4.75f);
            InvokeRepeating(nameof(SpawnFirefly),         wd13 / 3f,     5f);
        ...
        } else if (wave == 14)
        {
            ...
            InvokeRepeating(nameof(SpawnScorpion),        wd14 / 3f,     4.75f);
            InvokeRepeating(nameof(SpawnFireAnt),         waitTime,       1.65f);
            InvokeRepeating(nameof(SpawnTermiteCluster),  wd14 / 4f,     3.75f);
            InvokeRepeating(nameof(SpawnMoth),            wd14 / 3f,     4.5f);
            InvokeRepeating(nameof(SpawnFirefly),         wd14 / 3f,     4.75f);
        ...
        } else if (wave == 15)
        {
            ...
            InvokeRepeating(nameof(SpawnScorpion),        wd15 / 3f,     4.5f);
            InvokeRepeating(nameof(SpawnFireAnt),         waitTime,       1.55f);
            InvokeRepeating(nameof(SpawnTermiteCluster),  wd15 / 4f,     3.5f);
            InvokeRepeating(nameof(SpawnMoth),            wd15 / 3f,     4.25f);
            InvokeRepeating(nameof(SpawnFirefly),         wd15 / 3f,     4.5f);
        ...
        } else if (wave == 16)
        {
            ...
            InvokeRepeating(nameof(SpawnScorpion),        wd16 / 3f,     4.0f);
            InvokeRepeating(nameof(SpawnFireAnt),         waitTime,       1.5f);
            InvokeRepeating(nameof(SpawnTermiteCluster),  wd16 / 4f,     3.25f);
            InvokeRepeating(nameof(SpawnMoth),            wd16 / 3f,     4f);
            InvokeRepeating(nameof(SpawnFirefly),         wd16 / 3f,     4.25f);
        ...
        } else if (wave == 17)
        {
            ...
            InvokeRepeating(nameof(SpawnScorpion),        wd17 / 3f,     3.75f);
            InvokeRepeating(nameof(SpawnFireAnt),         waitTime,       1.45f);
            InvokeRepeating(nameof(SpawnTermiteCluster),  wd17 / 4f,     3.0f);
            InvokeRepeating(nameof(SpawnMoth),            wd17 / 3f,     3.75f);
            InvokeRepeating(nameof(SpawnFirefly),         wd17 / 3f,     4f);
        ...
        } else if (wave == 18)
        {
            ...
            InvokeRepeating(nameof(SpawnScorpion),        wd18 / 3f,     3.5f);
            InvokeRepeating(nameof(SpawnFireAnt),         waitTime,       1.4f);
            InvokeRepeating(nameof(SpawnTermiteCluster),  wd18 / 4f,     2.75f);
            InvokeRepeating(nameof(SpawnMoth),            wd18 / 3f,     3.5f);
            InvokeRepeating(nameof(SpawnFirefly),         wd18 / 3f,     3.75f);
        ...
        } else if (wave == 19)
        {
            ...
            InvokeRepeating(nameof(SpawnScorpion),        wd19 / 3f,     3.25f);
            InvokeRepeating(nameof(SpawnFireAnt),         waitTime,       1.35f);
            InvokeRepeating(nameof(SpawnTermiteCluster),  wd19 / 4f,     2.5f);
            InvokeRepeating(nameof(SpawnMoth),            wd19 / 3f,     3.25f);
            InvokeRepeating(nameof(SpawnFirefly),         wd19 / 3f,     3.5f);
        ...
        } else if (wave == 20)
        {
            ...
            InvokeRepeating(nameof(SpawnScorpion),        wd20 / 3f,     3.0f);
            InvokeRepeating(nameof(SpawnFireAnt),         waitTime,       1.3f);
            InvokeRepeating(nameof(SpawnTermiteCluster),  wd20 / 4f,     2.25f);
            InvokeRepeating(nameof(SpawnMoth),            wd20 / 3f,     3f);
            InvokeRepeating(nameof(SpawnFirefly),         wd20 / 3f,     3.25f);
        ...
        } else if (wave == 21)
        {
            ...
            InvokeRepeating(nameof(SpawnScorpion),        wd21 / 3f,     3.0f);
            InvokeRepeating(nameof(SpawnFireAnt),         waitTime,       1.25f);
            InvokeRepeating(nameof(SpawnTermiteCluster),  wd21 / 4f,     2.0f);
            InvokeRepeating(nameof(SpawnMoth),            wd21 / 3f,     2.75f);
            InvokeRepeating(nameof(SpawnFirefly),         wd21 / 3f,     3f);
        ...
        } else if (wave == 22)
        {
            ...
            InvokeRepeating(nameof(SpawnScorpion),        wd22 / 3f,     2.75f);
            InvokeRepeating(nameof(SpawnFireAnt),         waitTime,       1.2f);
            InvokeRepeating(nameof(SpawnTermiteCluster),  wd22 / 4f,     1.75f);
            InvokeRepeating(nameof(SpawnMoth),            wd22 / 3f,     2.5f);
            InvokeRepeating(nameof(SpawnFirefly),         wd22 / 3f,     2.75f);
        ...
        } else if (wave == 23)
        {
            ...
            InvokeRepeating(nameof(SpawnScorpion),        wd23 / 3f,     2.5f);
            InvokeRepeating(nameof(SpawnFireAnt),         waitTime,       1.15f);
            InvokeRepeating(nameof(SpawnTermiteCluster),  wd23 / 4f,     1.5f);
            InvokeRepeating(nameof(SpawnMoth),            wd23 / 3f,     2.25f);
            InvokeRepeating(nameof(SpawnFirefly),         wd23 / 3f,     2.5f);
        ...
        } else if (wave == 24)
        {
            ...
            InvokeRepeating(nameof(SpawnScorpion),        wd24 / 3f,     2.5f);
            InvokeRepeating(nameof(SpawnFireAnt),         waitTime,       1.15f);
            InvokeRepeating(nameof(SpawnTermiteCluster),  wd24 / 4f,     1.5f);
            InvokeRepeating(nameof(SpawnMoth),            wd24 / 3f,     2f);
            InvokeRepeating(nameof(SpawnFirefly),         wd24 / 3f,     2.25f);
