...
public class Level9 : SpawnManager
{
    public float levelTime;
    public int wave;
    private int startSunCount = 950, startHealth = 200;
    ...
    protected override void Start()
    {
        ...
        SaveManager.instance.saveData.highestLevelUnlocked = Mathf.Max(SaveManager.instance.saveData.highestLevelUnlocked, 8);
                SaveManager.instance.CompleteLevel(9);
    ...
    IEnumerator Wave(int wave)
    {
        if (wave == 1)
        {
            // Scout ants only, two phases — replacing the workers with scouts makes it slightly harder
            waitTime = 2f;
            spawnInterval = 1.8f;
            spawnCount = 20;
        ...
        {
            // Soldiers delayed to 1/3 mark; count reduced to 14
            waitTime = 2f;
            spawnInterval = 2.5f;
            spawnCount = 14;
            ...
            InvokeRepeating(nameof(SpawnSnail), wd2 * 0.5f, 28f);
            InvokeRepeating(nameof(SpawnMoth), wd2 * 0.5f, 18f);
        ...
        {
            // Scouts only at start; soldiers+fruitfly from 1/3; mosquito+snail+moth from 2/3
            waitTime = 2f;
            spawnInterval = 2.5f;
            spawnCount = 14;
            nextWaveTimer = waitTime + ((spawnCount - 1) * spawnInterval) + restInterval;
            ...
            InvokeRepeating(nameof(SpawnFruitFly), wd3 / 3f, spawnInterval * 1.5f);
            InvokeRepeating(nameof(SpawnMosquito), wd3 * 2f / 3f, 22f);
            InvokeRepeating(nameof(SpawnSnail), wd3 * 2f / 3f, 20f);
            InvokeRepeating(nameof(SpawnMoth), wd3 * 2f / 3f, 16f);
        ...
        {
            // Wasp/firefly/mosquito pushed to 1/2 mark (was 1/3)
            waitTime = 2f;
            spawnInterval = 3.0f;
            spawnCount = 15;
            nextWaveTimer = waitTime + ((spawnCount - 1) * spawnInterval) + restInterval;
            ...
            InvokeRepeating(nameof(SpawnWasp), wd4 * 0.5f, 16f);
            InvokeRepeating(nameof(SpawnFirefly), wd4 * 0.5f, 13f);
            InvokeRepeating(nameof(SpawnMosquito), wd4 * 0.5f, 20f);
            InvokeRepeating(nameof(SpawnSnail), wd4 * 2f / 3f, 14f);
            InvokeRepeating(nameof(SpawnMoth), wd4 * 2f / 3f, 12f);
        ...
        {
            // Wasp/firefly/mosquito pushed to 1/2 mark; slightly looser intervals
            waitTime = 2f;
            spawnInterval = 3.0f;
            spawnCount = 15;
            nextWaveTimer = waitTime + ((spawnCount - 1) * spawnInterval) + restInterval;
            ...
            InvokeRepeating(nameof(SpawnWasp), wd5 * 0.5f, 13f);
            InvokeRepeating(nameof(SpawnFirefly), wd5 * 0.5f, 10.5f);
            InvokeRepeating(nameof(SpawnMosquito), wd5 * 0.5f, 17f);
            InvokeRepeating(nameof(SpawnQueenAnt), wd5 * 2f / 3f, 13f);
            InvokeRepeating(nameof(SpawnSnail), wd5 * 2f / 3f, 11.5f);
            InvokeRepeating(nameof(SpawnMoth), wd5 * 2f / 3f, 10.5f);
        ...
        {
            // Wasp/firefly/mosquito pushed to 1/2; slightly looser intervals
            waitTime = 2f;
            spawnInterval = 3.5f;
            spawnCount = 15;
            nextWaveTimer = waitTime + ((spawnCount - 1) * spawnInterval) + restInterval;
            ...
            InvokeRepeating(nameof(SpawnWasp), wd6 * 0.5f, 12f);
            InvokeRepeating(nameof(SpawnFirefly), wd6 * 0.5f, 9f);
            InvokeRepeating(nameof(SpawnMosquito), wd6 * 0.5f, 14f);
            InvokeRepeating(nameof(SpawnQueenAnt), wd6 * 2f / 3f, 11f);
            InvokeRepeating(nameof(SpawnSnail), wd6 * 2f / 3f, 9.5f);
            InvokeRepeating(nameof(SpawnMoth), wd6 * 2f / 3f, 8.75f);
        ...
        } else if (wave == 7)
        {
            ...
            InvokeRepeating(nameof(SpawnWasp), wd7 * 0.5f, 10f);
            InvokeRepeating(nameof(SpawnFirefly), wd7 * 0.5f, 8f);
            InvokeRepeating(nameof(SpawnMosquito), wd7 * 0.5f, 12f);
            InvokeRepeating(nameof(SpawnQueenAnt), wd7 * 2f / 3f, 10f);
            InvokeRepeating(nameof(SpawnSnail), wd7 * 2f / 3f, 8f);
            InvokeRepeating(nameof(SpawnMoth), wd7 * 2f / 3f, 8.75f);
        ...
        } else if (wave == 8)
        {
            ...
            InvokeRepeating(nameof(SpawnWasp), wd8 / 3f, 7.25f);
            InvokeRepeating(nameof(SpawnFirefly), wd8 / 3f, 6.0f);
            InvokeRepeating(nameof(SpawnMosquito), wd8 / 3f, 9.5f);
            InvokeRepeating(nameof(SpawnQueenAnt), wd8 * 2f / 3f, 9.5f);
            InvokeRepeating(nameof(SpawnSnail), wd8 * 2f / 3f, 7.75f);
            InvokeRepeating(nameof(SpawnMoth), wd8 * 2f / 3f, 7.25f);
        ...
        } else if (wave == 9)
        {
            ...
            InvokeRepeating(nameof(SpawnFirefly), wd9 / 3f, 5.5f);
            InvokeRepeating(nameof(SpawnMosquito), wd9 / 3f, 8.75f);
            InvokeRepeating(nameof(SpawnQueenAnt), wd9 * 2f / 3f, 8.5f);
            InvokeRepeating(nameof(SpawnSnail), wd9 * 2f / 3f, 7.0f);
            InvokeRepeating(nameof(SpawnMoth), wd9 * 2f / 3f, 6.75f);
        ...
        } else if (wave == 10)
        {
            ...
            InvokeRepeating(nameof(SpawnWasp), wd10 / 3f, 5.75f);
            InvokeRepeating(nameof(SpawnFirefly), wd10 / 3f, 5.0f);
            InvokeRepeating(nameof(SpawnMosquito), wd10 / 3f, 8.25f);
            InvokeRepeating(nameof(SpawnQueenAnt), wd10 * 2f / 3f, 7.5f);
            InvokeRepeating(nameof(SpawnSnail), wd10 * 2f / 3f, 6.5f);
            InvokeRepeating(nameof(SpawnMoth), wd10 * 2f / 3f, 6.0f);
        ...
        } else if (wave == 11)
        {
            ...
            InvokeRepeating(nameof(SpawnWasp), wd11 / 3f, 5.0f);
            InvokeRepeating(nameof(SpawnFirefly), wd11 / 3f, 4.5f);
            InvokeRepeating(nameof(SpawnMosquito), wd11 / 3f, 7.75f);
            InvokeRepeating(nameof(SpawnQueenAnt), wd11 * 2f / 3f, 6.0f);
            InvokeRepeating(nameof(SpawnSnail), wd11 * 2f / 3f, 5.5f);
            InvokeRepeating(nameof(SpawnMoth), wd11 * 2f / 3f, 6.0f);
        ...
        } else if (wave == 12)
        {
            ...
            InvokeRepeating(nameof(SpawnWasp), wd12 / 3f, 4.25f);
            InvokeRepeating(nameof(SpawnFirefly), wd12 / 3f, 4.0f);
            InvokeRepeating(nameof(SpawnMosquito), wd12 / 3f, 7.25f);
            InvokeRepeating(nameof(SpawnQueenAnt), wd12 * 2f / 3f, 5.0f);
            InvokeRepeating(nameof(SpawnSnail), wd12 * 2f / 3f, 5.0f);
            InvokeRepeating(nameof(SpawnMoth), wd12 * 2f / 3f, 5.25f);
        ...
        } else if (wave == 13)
        {
            ...
            InvokeRepeating(nameof(SpawnWasp), wd13 / 3f, 3.75f);
            InvokeRepeating(nameof(SpawnFirefly), wd13 / 3f, 3.75f);
            InvokeRepeating(nameof(SpawnMosquito), wd13 / 3f, 7.0f);
            InvokeRepeating(nameof(SpawnQueenAnt), wd13 * 2f / 3f, 4.5f);
            InvokeRepeating(nameof(SpawnSnail), wd13 * 2f / 3f, 4.5f);
        ...
        } else if (wave == 14)
        {
            ...
            InvokeRepeating(nameof(SpawnWasp), wd14 / 3f, 3.25f);
            InvokeRepeating(nameof(SpawnFirefly), wd14 / 3f, 3.25f);
            InvokeRepeating(nameof(SpawnMosquito), wd14 / 3f, 6.5f);
            InvokeRepeating(nameof(SpawnQueenAnt), wd14 * 2f / 3f, 4.0f);
            InvokeRepeating(nameof(SpawnSnail), wd14 * 2f / 3f, 4.0f);
            InvokeRepeating(nameof(SpawnMoth), wd14 * 2f / 3f, 4.5f);
        ...
        } else if (wave == 15)
        {
            ...
            InvokeRepeating(nameof(SpawnFirefly), wd15 / 3f, 3.0f);
            InvokeRepeating(nameof(SpawnMosquito), wd15 / 3f, 6.0f);
            InvokeRepeating(nameof(SpawnQueenAnt), wd15 * 2f / 3f, 3.5f);
            InvokeRepeating(nameof(SpawnSnail), wd15 * 2f / 3f, 3.75f);
        ...
        } else if (wave == 16)
        {
            ...
            InvokeRepeating(nameof(SpawnMosquito), wd16 / 3f, 5.5f);
            InvokeRepeating(nameof(SpawnQueenAnt), wd16 * 2f / 3f, 3.25f);
            InvokeRepeating(nameof(SpawnSnail), wd16 * 2f / 3f, 2.25f);
        ...
        } else if (wave == 18)
        {
            ...
            InvokeRepeating(nameof(SpawnFirefly), wd18 / 3f, 2.25f);
            InvokeRepeating(nameof(SpawnMosquito), wd18 / 3f, 4.5f);
        ...
        } else if (wave == 19)
        {
            ...
            InvokeRepeating(nameof(SpawnWasp), wd19 / 3f, 3.0f);
            InvokeRepeating(nameof(SpawnFirefly), wd19 / 3f, 2.0f);
            InvokeRepeating(nameof(SpawnMosquito), wd19 / 3f, 4.25f);
            InvokeRepeating(nameof(SpawnQueenAnt), wd19 * 2f / 3f, 3.0f);
            InvokeRepeating(nameof(SpawnSnail), wd19 * 2f / 3f, 2f);
            InvokeRepeating(nameof(SpawnMoth), wd19 * 2f / 3f, 2.75f);
        ...
        } else if (wave == 20)
        {
            ...
            InvokeRepeating(nameof(SpawnWasp), wd20 / 3f, 2.75f);
            InvokeRepeating(nameof(SpawnFirefly), wd20 / 3f, 2.0f);
            InvokeRepeating(nameof(SpawnMosquito), wd20 / 3f, 4.0f);
            InvokeRepeating(nameof(SpawnQueenAnt), wd20 * 2f / 3f, 3.0f);
            InvokeRepeating(nameof(SpawnSnail), wd20 * 2f / 3f, 1.75f);
            InvokeRepeating(nameof(SpawnMoth), wd20 * 2f / 3f, 2.5f);
        ...
        } else if (wave == 21)
        {
            ...
            InvokeRepeating(nameof(SpawnWasp), wd21 / 3f, 2.5f);
            InvokeRepeating(nameof(SpawnFirefly), wd21 / 3f, 2.0f);
            InvokeRepeating(nameof(SpawnMosquito), wd21 / 3f, 3.75f);
            InvokeRepeating(nameof(SpawnQueenAnt), wd21 * 2f / 3f, 2.75f);
            InvokeRepeating(nameof(SpawnSnail), wd21 * 2f / 3f, 1.75f);
            InvokeRepeating(nameof(SpawnMoth), wd21 * 2f / 3f, 2.25f);
    ...
    public override GameObject[] GetInsectPrefabs() => new[] { soldierAnt, scoutAnt, fruitFly, wasp, queenAnt, snail, moth, firefly, mosquito };
