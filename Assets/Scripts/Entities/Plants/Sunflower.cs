...
public class Sunflower : Shooter
{
    ...
    public override string GetPath2Description(bool details = false)
    {
        ...
        string scaling = details
            ...
            : $"Increase Sun Generated by <color=green><b>{sunpl}</b></color>.\n\n" +
              $"Reduce Sun Generation Cooldown by <color=green><b>1</b></color> second.";
    ...
    public override string GetPath3Description(bool details = false)
    {
        ...
        string scaling = details
            ...
            : $"Increase Sunray Damage by <color=green><b>{dpspl:F0}</b></color>.\n\n" +
              $"Increase Sunray duration by <color=green><b>{durpl:F1}</b></color> second.";
        return $"Skill:\n\n{GetSkillDesription()}\n\n" +
               $"{scaling}\n\n" +
