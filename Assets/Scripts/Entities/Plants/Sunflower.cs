...
public class Sunflower : Shooter
{
    ...
    {
        attackDamageTotalMultiplier = effectivePath1Level >= pathLevelCap ? 0.5f : 1f;
        base.UpdateStats();
    ...
    private IEnumerator ChannelAndSpawn(Vector3 position)
    {
        ...
        if (effectivePath3Level >= pathLevelCap)
        {
    ...
    public override string GetPath1Description(bool details = false)
    {
        ...
        return $"Attack:\n\n{desc}\n\n" +
               ...
               $"{Level5Section(effectivePath1Level, effectivePath1Level >= pathLevelCap ? "Reduce Total Attack Damage by <color=green><b>50%</b></color>. Attacks now shoot <color=green><b>3</b></color> projectiles to the target." : "Reduce Total Attack Damage by 50%. Attacks now shoot 3 projectiles to the target.")}\n\n" +
    ...
    public override string GetPath2Description(bool details = false)
    {
        ...
        string fireDmgRef = path2Maxed ? "<color=red><b>Fire Damage</b></color>" : "Fire Damage";
        string sunMarkRef = path2Maxed ? "<color=#FFD700><b>Sun Mark</b></color>" : "Sun Mark";
        string sunRef     = path2Maxed ? "<color=yellow>Sun</color>" : "Sun";
        string pctRef     = path2Maxed ? "<color=green><b>27%</b></color>" : "27%";
        string passiveMaxBonus = $"Dealing {fireDmgRef} inflicts {sunMarkRef}, increasing the {sunRef} yield of the target by {pctRef}.";
        string desc = details
    ...
    public override string GetPath3Description(bool details = false)
    {
        ...
        return $"Skill:\n\n{desc}\n\n" +
               ...
               $"{Level5Section(effectivePath3Level, $"Unleashes an additional {(effectivePath3Level >= pathLevelCap ? "<color=orange><b>Sunray</b></color>" : "<b>Sunray</b>")} at a random insect's location on the map.")}\n\n" +
