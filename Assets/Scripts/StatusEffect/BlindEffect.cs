public class BlindEffect : StatusEffect
{
    ...
    public override void OnApply()  => target.accuracyAdder -= accuracyPenalty;
    ...
    public override string GetDescription() =>
        $"Accuracy reduced by <color=white><b>{accuracyPenalty * 100f:F0}%</b></color>, causing attacks to frequently miss.";
}
