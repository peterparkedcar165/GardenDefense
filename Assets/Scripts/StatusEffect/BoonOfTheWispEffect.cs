// applied by a Cinderwisp while latched. inherits the per-second regen tick from RegenerationEffect
// and also boosts the plant's fire damage while active
public class BoonOfTheWispEffect : RegenerationEffect
{
    private readonly float _fireDamageFrac;

    public BoonOfTheWispEffect(Entity target, float duration, int level, Entity source,
    ...
    public override string GetName() => "<color=orange><b>Boon of The Wisp</b></color>";
