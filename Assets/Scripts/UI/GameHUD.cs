...
public class GameHUD : MonoBehaviour
{
    ...
    public void SetNextWaveTimer(float t)    { NextWaveCountdown = t; if (nextWaveTimerText) nextWaveTimerText.text = t < 0f ? "Final Wave" : $"Next Wave: {Mathf.CeilToInt(Mathf.Max(0, t))}s"; }
