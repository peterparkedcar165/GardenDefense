...
[CreateAssetMenu(fileName = "DahliaData", menuName = "Scriptable Objects/PlantData/Dahlia")]
public class DahliaData : PlantData
{
    ...
    public float baseBurgeonHeal     = 10f;
    ...
    public float path3CooldownReductionPerLevel = 5f;
    ...
    public override string GetSkillDescription() =>
        $"Target a tile where a plant has fallen to resurrect it. The plant is revived with <color=green><b>20%</b></color> of its maximum health.";
}
