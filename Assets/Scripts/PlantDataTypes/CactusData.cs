...
public class CactusData : PlantData
{
    ...
    public override string GetSkillDescription() =>
        $"Gains a <color=grey><b>{baseShieldAmount:F0}</b></color> shield and taunts insects within range for <color=green><b>12</b></color> seconds. Healing received increased by <color=green><b>16%</b></color> during the effect.";
}
