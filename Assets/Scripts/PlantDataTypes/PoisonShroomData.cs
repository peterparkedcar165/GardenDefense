...
public class PoisonShroomData : PlantData
{
    ...
    public override string GetPassiveDescription() =>
        $"Attacks apply a <color=purple>Poison</color> effect on hit for <color=green><b>{basePoisonDuration}</b></color> seconds, dealing <color=green><b>{basePoisonDPS}</b></color> <color=purple>Poison</color> damage per second.";
