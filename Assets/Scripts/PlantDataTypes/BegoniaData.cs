...
public class BegoniaData : PlantData
{
    ...
    public override string GetSkillDescription() =>
        "Target an area on the field. Plants within the selected area are granted <color=green><b>Blossoming</b></color>, increasing <color=green><b>Nature Power</b></color> and <color=green><b>Attack Speed</b></color>. Scales with <color=#FFB6C1><b>Magic Power</b></color>.";
}
